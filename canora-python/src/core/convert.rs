...
pub fn py_key_to_notes(key: &str) -> PyResult<Vec<String>> { canora::core::notation::key_to_notes(key).into_pyresult() }

#[pyfunction] #[pyo3(name = "key_to_degrees")]
pub fn py_key_to_degrees(key: &str) -> PyResult<Vec<usize>> { canora::core::notation::key_to_degrees(key).into_pyresult() }

#[pyfunction] #[pyo3(name = "mela_to_degrees")]
pub fn py_mela_to_degrees(mela: usize) -> PyResult<Vec<usize>> { canora::core::notation::mela_to_degrees(mela).into_pyresult() }

#[pyfunction] #[pyo3(name = "mela_to_svara")]
pub fn py_mela_to_svara(mela: usize) -> PyResult<Vec<String>> { canora::core::notation::mela_to_svara(mela).into_pyresult() }

#[pyfunction] #[pyo3(name = "thaat_to_degrees")]
pub fn py_thaat_to_degrees(thaat: &str) -> PyResult<Vec<usize>> { canora::core::notation::thaat_to_degrees(thaat).into_pyresult() }

#[pyfunction] #[pyo3(name = "list_mela")]
pub fn py_list_mela() -> Vec<String> { canora::core::notation::list_mela() }

#[pyfunction] #[pyo3(name = "list_thaat")]
pub fn py_list_thaat() -> Vec<String> { canora::core::notation::list_thaat() }

#[pyfunction] #[pyo3(name = "fifths_to_note")]
pub fn py_fifths_to_note(fifths: i32) -> String { canora::core::notation::fifths_to_note(fifths) }

#[pyfunction] #[pyo3(name = "interval_to_fjs")]
pub fn py_interval_to_fjs(interval: f64) -> String { canora::core::notation::interval_to_fjs(interval) }

#[pyfunction] #[pyo3(name = "interval_frequencies", signature = (n_bins, *, fmin=32.7, intervals, bins_per_octave=12))]
pub fn py_interval_frequencies<'py>(py: Python<'py>, n_bins: usize, fmin: f64, intervals: Vec<f64>, bins_per_octave: usize) -> Bound<'py, PyArray1<f64>> { canora::core::intervals::interval_frequencies(n_bins, fmin, &intervals, bins_per_octave).into_pyarray(py) }

#[pyfunction] #[pyo3(name = "pythagorean_intervals", signature = (*, bins_per_octave=12))]
pub fn py_pythagorean_intervals<'py>(py: Python<'py>, bins_per_octave: usize) -> Bound<'py, PyArray1<f64>> { canora::core::intervals::pythagorean_intervals(bins_per_octave).into_pyarray(py) }

#[pyfunction] #[pyo3(name = "plimit_intervals", signature = (*, p=5, bins_per_octave=12))]
pub fn py_plimit_intervals<'py>(py: Python<'py>, p: usize, bins_per_octave: usize) -> Bound<'py, PyArray1<f64>> { canora::core::intervals::plimit_intervals(p, bins_per_octave).into_pyarray(py) }
