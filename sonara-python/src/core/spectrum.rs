...
pub fn py_db_to_power<'py>(py: Python<'py>, s_db: PyReadonlyArray2<'py, f32>, ref_power: f32) -> Bound<'py, PyArray2<f32>> {
    rs::db_to_power(s_db.as_array(), ref_power).into_pyarray(py)
}

#[pyfunction]
#[pyo3(name = "db_to_amplitude", signature = (s_db, *, ref_amplitude=1.0))]
pub fn py_db_to_amplitude<'py>(py: Python<'py>, s_db: PyReadonlyArray2<'py, f32>, ref_amplitude: f32) -> Bound<'py, PyArray2<f32>> {
    rs::db_to_amplitude(s_db.as_array(), ref_amplitude).into_pyarray(py)
}

#[pyfunction]
#[pyo3(name = "magphase", signature = (d, *, power=1.0))]
pub fn py_magphase<'py>(py: Python<'py>, d: PyReadonlyArray2<'py, Complex32>, power: f32) -> (Bound<'py, PyArray2<f32>>, Bound<'py, PyArray2<Complex32>>) {
...
pub fn py_phase_vocoder<'py>(py: Python<'py>, d: PyReadonlyArray2<'py, Complex32>, rate: f32, hop_length: Option<usize>) -> PyResult<Bound<'py, PyArray2<Complex32>>> {
...
pub fn py_pcen<'py>(py: Python<'py>, s: PyReadonlyArray2<'py, f32>, sr: f32, hop_length: usize, gain: f32, bias: f32, power: f32, time_constant: f32, eps: f32) -> PyResult<Bound<'py, PyArray2<f32>>> {
...
pub fn py_perceptual_weighting<'py>(py: Python<'py>, s: PyReadonlyArray2<'py, f32>, frequencies: PyReadonlyArray1<'py, f32>, kind: &str) -> PyResult<Bound<'py, PyArray2<f32>>> {
...
pub fn py_cqt<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, sr: u32, hop_length: usize, fmin: Option<f32>, n_bins: usize, bins_per_octave: usize, filter_scale: f32) -> PyResult<Bound<'py, PyArray2<Complex32>>> {
...
pub fn py_vqt<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, sr: u32, hop_length: usize, fmin: Option<f32>, n_bins: usize, bins_per_octave: usize, filter_scale: f32, gamma: f32) -> PyResult<Bound<'py, PyArray2<Complex32>>> {
...
pub fn py_hybrid_cqt<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, sr: u32, hop_length: usize, fmin: Option<f32>, n_bins: usize, bins_per_octave: usize, filter_scale: f32) -> PyResult<Bound<'py, PyArray2<Complex32>>> {
...
pub fn py_pseudo_cqt<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, sr: u32, hop_length: usize, fmin: Option<f32>, n_bins: usize, bins_per_octave: usize, filter_scale: f32) -> PyResult<Bound<'py, PyArray2<f32>>> {
...
pub fn py_icqt<'py>(py: Python<'py>, cq: PyReadonlyArray2<'py, Complex32>, sr: u32, hop_length: usize, fmin: Option<f32>, bins_per_octave: usize, filter_scale: f32) -> PyResult<Bound<'py, numpy::PyArray1<f32>>> {
...
pub fn py_griffinlim_cqt<'py>(py: Python<'py>, cq_mag: PyReadonlyArray2<'py, f32>, sr: u32, hop_length: usize, fmin: Option<f32>, bins_per_octave: usize, n_iter: usize) -> PyResult<Bound<'py, numpy::PyArray1<f32>>> {
...
pub fn py_yin<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, fmin: f32, fmax: f32, sr: u32, frame_length: usize, hop_length: Option<usize>, trough_threshold: f32) -> PyResult<Bound<'py, numpy::PyArray1<f32>>> {
...
pub fn py_pyin<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, fmin: f32, fmax: f32, sr: u32, frame_length: usize, hop_length: Option<usize>) -> PyResult<(Bound<'py, numpy::PyArray1<f32>>, Bound<'py, numpy::PyArray1<bool>>, Bound<'py, numpy::PyArray1<f32>>)> {
...
pub fn py_estimate_tuning(y: Option<PyReadonlyArray1<'_, f32>>, sr: u32, n_fft: Option<usize>, resolution: Option<f32>, bins_per_octave: Option<usize>) -> PyResult<f32> {
...
pub fn py_pitch_tuning(pitches: Vec<f32>, resolution: Option<f32>, bins_per_octave: Option<usize>) -> PyResult<f32> {
...
pub fn py_piptrack<'py>(py: Python<'py>, y: PyReadonlyArray1<'py, f32>, sr: u32, n_fft: usize, hop_length: Option<usize>) -> PyResult<(Bound<'py, PyArray2<f32>>, Bound<'py, PyArray2<f32>>)> {
...
pub fn py_salience<'py>(py: Python<'py>, s: PyReadonlyArray2<'py, f32>, freqs: PyReadonlyArray1<'py, f32>, harmonics: Vec<usize>, weights: Option<Vec<f32>>, fill_value: f32) -> PyResult<Bound<'py, PyArray2<f32>>> {
...
pub fn py_interp_harmonics<'py>(py: Python<'py>, s: PyReadonlyArray2<'py, f32>, freqs: PyReadonlyArray1<'py, f32>, harmonics: Vec<f32>, fill_value: f32) -> PyResult<Bound<'py, PyArray2<f32>>> {
...
pub fn py_f0_harmonics<'py>(py: Python<'py>, s: PyReadonlyArray2<'py, f32>, freqs: PyReadonlyArray1<'py, f32>, f0: PyReadonlyArray1<'py, f32>, harmonics: Vec<f32>, fill_value: f32) -> PyResult<Bound<'py, PyArray2<f32>>> {
